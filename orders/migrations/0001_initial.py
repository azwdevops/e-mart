# Generated by Django 4.2.11 on 2024-03-22 11:29
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('address_line_1', models.EmailField(max_length=50)),
                ('address_line_2', models.EmailField(blank=True, max_length=50)),
                ('country', models.EmailField(max_length=50)),
                ('state', models.EmailField(max_length=50)),
                ('city', models.EmailField(max_length=50)),
                ('order_note', models.EmailField(blank=True, max_length=100)),
